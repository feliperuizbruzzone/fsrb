...
## Current positions
**Project Manager** -- Half-time <br> *Nodo XXI Foundation* [*2019 --- present*]{.cvdate}
...
### Professional
**Data Science -- Profesional Specialization** <br> *John Hopkins University* [*2024*]{.cvdate}

**Programming & Data Science Instructor** -- Profesional Specialization <br> *The Carpentries* [*2023*]{.cvdate}
...
Providing data collection, pre-processing, statistical analysis and data visualization services to different clients of the scientific and academic sector. The last projects I was involved were:
...
- Project title: *The Capitalist Class in Contemporary Chile (1990-2020). A study based on the case of the Luksic and Cencosud economic groups* 
